                    ...
                    <div class="card-body">
                        ...
                        @if(isset($recaptcha) && $recaptcha['status'] == 1)
                            <div class="d-flex justify-content-center">
                                <div id="recaptcha-element-vendor-register" class="w-100"></div>
                            </div>
                        @else
                            <div class="mt-2">
                                <div class="row py-2">
                                    ...
                                    <span class="d-flex align-items-center align-items-center get-vendor-regi-recaptcha-verify"
                                          data-link="{{ vendor_route('vendor.auth.recaptcha', ['tmp'=>':dummy-id']) }}">
                                        <img src="{{ vendor_route('vendor.auth.recaptcha', ['tmp'=>1]).'?captcha_session_id=sellerRecaptchaSessionKey' }}" alt="" class="rounded __h-40" id="default_recaptcha_id">
