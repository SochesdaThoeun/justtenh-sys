                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-sm-5 footer-padding-bottom offset-max-sm--1 pb-3 pb-sm-0">
                                <div class="mb-2">
                                    <h6 class="text-uppercase mobile-fs-12 font-semi-bold footer-header text-center text-sm-start">{{ translate('weaccept')}}</h6>

                                </div>
                                <div class="d-flex justify-content-start mb-2 align-items-start">
                                    <img width="40" src="{{dynamicStorage(path: 'storage/app/public/payment_modules/gateway_image/KHQR.svg')}}" alt="">
                                </div>
                            </div>
                        </div>
