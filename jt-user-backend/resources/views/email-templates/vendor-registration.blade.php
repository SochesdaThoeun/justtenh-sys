    ...
    <tr>
        <td class="main-table-td">
            ...
            @elseif($data['status'] == 'approved')
                ...
                <p style="font-size: 14px; color: #484848; line-height: 28px; margin-bottom:0px; text-align: center;">
                    @if($shop_name)
                        <a href="{{route('shopView',[$seller->id])}}" target="_blank" style="text-decoration: underline;"> {{$shop_name}}</a>
                    @else
                        <a href="{{vendor_route('vendor.auth.login')}}" target="_blank"
                        style="text-decoration: underline; color: #0381ff !important; font-weight:bold">{{translate('login_to_add_your_shop_name')}} </a>
                    @endif
                </p>
            @endif
