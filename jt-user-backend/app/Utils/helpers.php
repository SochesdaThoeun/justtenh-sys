...
//        return (($price-$discount) / 100) * $tax; //after discount decrease
    ...
    */
    ...
    public static function send_push_notif_to_topic($data, $topic = '')
    {
        $key = BusinessSetting::where(['type' => 'push_notification_key'])->first()->value;
...
if (!function_exists('payment_gateways')) {
    function payment_gateways()
    {
        ...
        // Log the value of paymentGatewayPublishedStatus
        Log::info('Payment Gateway Published Status:', ['payment_gateways_query' => $payment_gateways_list]);
