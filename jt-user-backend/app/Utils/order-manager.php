...
class OrderManager
{
    ...
    {
        Log::info('Generate order check point 1');
        $req = array_key_exists('request', $data) ? $data['request'] : null;
        ...
        Log::info('Generate order check point 2');
        ...
        Log::info('Generate order check point 3');
        ...
        Log::info('Generate order check point 4');
        ...
        Log::info('Generate order check point 5');
        ...
        Log::info('Generate order check point 6');
        $or = [
            'id' => $order_id,
        ...
        Log::info('Generate order check point 7');
        ...
        foreach (CartManager::get_cart(groupId: $data['cart_group_id'], type: 'checked') as $cartSingleItem) {
            ...
            Log::info('Generate order check point 8');
            ...
            Log::info('Generate order check point 9');
            ...
            Log::info('Generate order check point 10');
        ...
        Log::info('Generate order check point 11');
        ...
        if ($or['payment_method'] != 'cash_on_delivery' && $or['payment_method'] != 'offline_payment') {
            ...
            Log::info('Generate order check point 12');
            ...
            Log::info('Generate order check point 13');
        ...
        Log::info('Generate order check point 14');
        if ($seller_data->seller_is == 'admin') {
        ...
        Log::info('Generate order check point 15');

        try {
            Log::info('Generate order check point 16');
        ...
        Log::info('Generate order check point 17');
