...
use App\Http\Controllers\RestAPI\v3\seller\CustomerController;
...
use App\Http\Controllers\RestAPI\v3\seller\StatisticController;
...
Route::group(['namespace' => 'RestAPI\v3\seller', 'prefix' => 'v3/seller', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['middleware' => ['seller_api_auth']], function () {
        Route::controller(SellerController::class)->group(function () {
            ...
            Route::put('shop-product-reviews-status', 'shop_product_reviews_status');
            Route::post('seller-update', 'seller_info_update');
            ...
            Route::post('shop-update', 'shop_info_update');
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::group(['prefix' => 'products'], function () {
                ...
                Route::get('/check-default-lang', function() {
                    return response()->json(['default_lang' => Helpers::default_lang()]);
                });
            });
        });
        ...
        Route::group(['prefix' => 'orders'], function () {
            Route::controller(OrderController::class)->group(function () {
                ...
                Route::post('edit-order', 'edit_order');
            });
        });
        ...
        Route::controller(StatisticController::class)->group(function () {
            Route::get('statistics/sales-chart', 'salesChartData');
            Route::get('statistics/customer-orders', 'customerOrdersList');
            Route::get('statistics/orders-per-day', 'ordersPerDay');
            Route::get('statistics/shipping-cost', 'shippingCostByMethod');
            Route::get('statistics/return-orders', 'returnOrdersPerDay');
            Route::get('statistics/product-performance', 'productPerformance');
        });
