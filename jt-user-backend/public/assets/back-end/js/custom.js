...
$(document).ready(function () {
    if (
        document.cookie.indexOf("justtenh_stock_limit_status=accepted") !== -1 ||
        document.cookie.indexOf("justtenh_stock_limit_status=reject") !== -1
    ) {
...
$(document).on("click", ".product-stock-alert-hide", function () {
    document.cookie =
        "justtenh_stock_limit_status=accepted; max-age=" +
        60 * 60 * 24 * 30 +
        "; path=/";
    $(".product-limited-stock-alert").hide();
});
...
$(document).on("click", ".product-stock-limit-close", function () {
    document.cookie =
        "justtenh_stock_limit_status=reject; max-age=" + 60 * 20 + "; path=/";
    $(".product-limited-stock-alert").hide();
});
