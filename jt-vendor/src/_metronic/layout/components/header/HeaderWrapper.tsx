      ...
      >
        ...
        <div className='d-flex d-lg-none align-items-center ms-n2 me-2'>
          ...
          <Link to='/dashboard' className='d-flex align-items-center'>
            <img alt='Logo' src={toAbsoluteUrl('media/logos/custom-1-light.svg')} className='theme-light-show h-20px' />
            <img alt='Logo' src={toAbsoluteUrl('media/logos/custom-1.svg')} className='theme-dark-show h-20px' />
          </Link>
          {/* end::Logo */}
        </div>
        {/* end::Wrapper */}
